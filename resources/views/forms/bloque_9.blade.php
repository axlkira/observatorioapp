                ...
                <form method="POST" action="{{ route('form.store') }}" autocomplete="off" id="bloque9Form">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            @php
                                $p46 = [
                                    'p46_vida_libre_violencia' => old('p46_vida_libre_violencia', $registro->p46_vida_libre_violencia ?? 0),
                                    'p46_participacion_representacion' => old('p46_participacion_representacion', $registro->p46_participacion_representacion ?? 0),
                                    'p46_trabajo_digno' => old('p46_trabajo_digno', $registro->p46_trabajo_digno ?? 0),
                                    'p46_salud_seguridad' => old('p46_salud_seguridad', $registro->p46_salud_seguridad ?? 0),
                                    'p46_educacion_igualdad' => old('p46_educacion_igualdad', $registro->p46_educacion_igualdad ?? 0),
                                    'p46_recreacion_cultura' => old('p46_recreacion_cultura', $registro->p46_recreacion_cultura ?? 0),
                                    'p46_honra_dignidad' => old('p46_honra_dignidad', $registro->p46_honra_dignidad ?? 0),
                                    'p46_igualdad' => old('p46_igualdad', $registro->p46_igualdad ?? 0),
                                    'p46_armonia_unidad' => old('p46_armonia_unidad', $registro->p46_armonia_unidad ?? 0),
                                    'p46_proteccion_asistencia' => old('p46_proteccion_asistencia', $registro->p46_proteccion_asistencia ?? 0),
                                    'p46_entornos_seguros' => old('p46_entornos_seguros', $registro->p46_entornos_seguros ?? 0),
                                    'p46_decidir_hijos' => old('p46_decidir_hijos', $registro->p46_decidir_hijos ?? 0),
                                    'p46_orientacion_asesoria' => old('p46_orientacion_asesoria', $registro->p46_orientacion_asesoria ?? 0),
                                    'p46_respetar_formacion_hijos' => old('p46_respetar_formacion_hijos', $registro->p46_respetar_formacion_hijos ?? 0),
                                    'p46_respeto_reciproco' => old('p46_respeto_reciproco', $registro->p46_respeto_reciproco ?? 0),
                                    'p46_proteccion_patrimonio' => old('p46_proteccion_patrimonio', $registro->p46_proteccion_patrimonio ?? 0),
                                    'p46_alimentacion_necesidades' => old('p46_alimentacion_necesidades', $registro->p46_alimentacion_necesidades ?? 0),
                                    'p46_bienestar' => old('p46_bienestar', $registro->p46_bienestar ?? 0),
                                    'p46_apoyo_estado_mayores' => old('p46_apoyo_estado_mayores', $registro->p46_apoyo_estado_mayores ?? 0),
                                    'p46_ninguno_anteriores' => old('p46_ninguno_anteriores', $registro->p46_ninguno_anteriores ?? 0),
                                ];
                                $opciones = [
